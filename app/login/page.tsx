...
import { IdCard, Zap, Users } from "lucide-react";
          ...
          <div className="relative space-y-6">
            ...
            <div>
              ...
              <input
                ...
                maxLength={5}
                autoFocus
                className={`w-full px-4 py-3.5 rounded-xl bg-[rgba(15,15,20,0.9)] border text-white placeholder-gray-600 text-sm font-mono tracking-[0.4em] text-center uppercase focus:outline-none transition-all duration-300 border-white/10 focus:border-[#C6FF00]/50 focus:ring-1 focus:ring-[#C6FF00]/20 focus:shadow-[0_0_15px_rgba(198,255,0,0.1)]`}
              />
            </div>
            ...
            <button
              onClick={() => {}}
              className="w-full py-3.5 rounded-xl text-sm font-bold uppercase tracking-wider bg-[#C6FF00] text-[#0a0a0f] shadow-lg shadow-[#C6FF00]/25 hover:shadow-[#C6FF00]/50 hover:brightness-110 hover:scale-[1.01] active:scale-[0.99] transition-all duration-300 cursor-pointer"
            >
              Start Quiz
            </button>
          </div>
